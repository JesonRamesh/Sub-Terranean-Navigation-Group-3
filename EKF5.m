...
% --- Gyro ---
GYRO_YAW_ROW = 1;
GYRO_BIAS_WINDOW_SEC = 2.0;   % seconds at start to average for online bias
...
Q_THETA = 1e-3;      % Allow yaw uncertainty to grow — ToF can correct it

% --- Velocity damping ---
VEL_DAMPING = 0.95;

% --- ToF measurement noise ---
R_TOF = 0.01;        % Trust ToF strongly
